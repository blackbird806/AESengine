...
namespace wob
{
	...
	public:
		...
		constexpr StringView(const char* str) noexcept : data_(str), size_(strlen(str)) { }
		...
		{
			WOB_BOUND_CHECK(start + count < size_);
