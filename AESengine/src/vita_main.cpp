...
public:
	...
	void start() override
	{
		...
		vertexInputLayout[1].offset = sizeof(glm::vec2) * 1;
	...
	void update(float dt) override
	{
		...
		camera.projMatrix = glm::perspectiveLH_ZO(glm::radians(45.0f), aspect, 0.1f, 100.0f);
		...
		modelBuffer.setDataFromPOD(identity);
