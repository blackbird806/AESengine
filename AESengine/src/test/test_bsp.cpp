...
public:
	...
	void start() override
	{
...

		{
			...
			viewDesc.usage = MemoryUsage::Dynamic;
		...
		}
		{
			...
			identityDesc.usage = MemoryUsage::Immutable;
	...
	void draw() override
	{
		...
		for (auto& e : testElements)
		{
			...
			// uncomment this to display elements by looking at them
			// this was used to test the raycast in bsp
			//if(e.coll)
			{
				e.model.draw();
			}
